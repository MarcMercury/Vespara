...
class MockDataProvider {
  ...
  static List<TagsGame> get tagsGames => [
    ...
    TagsGame(
      id: 'game-6',
      title: 'Flash & Freeze',
      description: 'Red Light Green Light with an adult twist. Quick reactions required.',
    ...
    TagsGame(
      id: 'game-7',
      title: 'Drama-Sutra Tonight',
      description: 'Improv meets intimacy. Act out scenarios together.',
