...
class LaneOfLustNotifier extends StateNotifier<LaneOfLustState> {
  ...
  List<LaneCard> _generateDemoDeck() {
    ...
    return [
      // Low (1-30)
      LaneCard(id: id(), text: 'Your partner forgets your birthday', desireIndex: 5, category: LaneCardCategory.vanilla),
      LaneCard(id: id(), text: 'Getting a handshake instead of a hug', desireIndex: 3, category: LaneCardCategory.vanilla),
      LaneCard(id: id(), text: 'A peck on the forehead from grandma', desireIndex: 2, category: LaneCardCategory.vanilla),
      LaneCard(id: id(), text: 'A quick peck on the cheek', desireIndex: 12, category: LaneCardCategory.vanilla),
      LaneCard(id: id(), text: 'Brushing hands accidentally', desireIndex: 15, category: LaneCardCategory.vanilla),
      LaneCard(id: id(), text: 'Sitting next to your crush on the bus', desireIndex: 18, category: LaneCardCategory.vanilla),
      LaneCard(id: id(), text: 'Holding hands in a movie theater', desireIndex: 25, category: LaneCardCategory.romance),
      LaneCard(id: id(), text: 'A wink from across the room', desireIndex: 20, category: LaneCardCategory.vanilla),
      LaneCard(id: id(), text: 'Sharing dessert at dinner', desireIndex: 28, category: LaneCardCategory.romance),
      
      // Medium-Low (31-45)
      LaneCard(id: id(), text: 'Dancing close at a wedding', desireIndex: 32, category: LaneCardCategory.romance),
      LaneCard(id: id(), text: 'A long hug that lingers', desireIndex: 35, category: LaneCardCategory.romance),
      LaneCard(id: id(), text: 'Slow dancing in the living room', desireIndex: 38, category: LaneCardCategory.romance),
      LaneCard(id: id(), text: 'A kiss on the neck', desireIndex: 42, category: LaneCardCategory.romance),
      LaneCard(id: id(), text: 'Playing footsie under the table', desireIndex: 37, category: LaneCardCategory.romance),
      
      // Medium (46-60)
      LaneCard(id: id(), text: 'A sensual back massage with oil', desireIndex: 48, category: LaneCardCategory.romance),
      LaneCard(id: id(), text: 'Receiving a flirty text at work', desireIndex: 52, category: LaneCardCategory.romance),
      LaneCard(id: id(), text: 'Making out in a parked car', desireIndex: 55, category: LaneCardCategory.romance),
      LaneCard(id: id(), text: 'Shower sex that actually works', desireIndex: 58, category: LaneCardCategory.wild),
      LaneCard(id: id(), text: 'Skinny dipping at night', desireIndex: 56, category: LaneCardCategory.wild),
      LaneCard(id: id(), text: 'Morning sex that makes you late', desireIndex: 57, category: LaneCardCategory.wild),
      
      // Medium-High (61-75)
      LaneCard(id: id(), text: 'Sex in a hotel room on vacation', desireIndex: 62, category: LaneCardCategory.wild),
      LaneCard(id: id(), text: 'Using a new toy together', desireIndex: 65, category: LaneCardCategory.kinky),
      LaneCard(id: id(), text: 'Dirty talk that actually works', desireIndex: 68, category: LaneCardCategory.kinky),
      LaneCard(id: id(), text: 'Blindfolded and at their mercy', desireIndex: 72, category: LaneCardCategory.kinky),
      LaneCard(id: id(), text: 'Public teasing under the table', desireIndex: 70, category: LaneCardCategory.wild),
      
      // High (76-90)
      LaneCard(id: id(), text: 'A weekend getaway to a private cabin', desireIndex: 78, category: LaneCardCategory.romance),
      LaneCard(id: id(), text: 'Being dominated (the way you like)', desireIndex: 82, category: LaneCardCategory.kinky),
      LaneCard(id: id(), text: 'Mile High Club membership', desireIndex: 85, category: LaneCardCategory.wild),
      LaneCard(id: id(), text: 'Being tied up and teased for an hour', desireIndex: 88, category: LaneCardCategory.kinky),
      LaneCard(id: id(), text: 'All-night session with no interruptions', desireIndex: 84, category: LaneCardCategory.wild),
      
      // Extreme (91-100)
      LaneCard(id: id(), text: 'A surprise threesome with consent', desireIndex: 95, category: LaneCardCategory.wild),
      LaneCard(id: id(), text: 'Your deepest fantasy fulfilled', desireIndex: 98, category: LaneCardCategory.kinky),
      LaneCard(id: id(), text: 'Being worshipped all evening', desireIndex: 92, category: LaneCardCategory.kinky),
      LaneCard(id: id(), text: 'A vacation where you barely leave the room', desireIndex: 93, category: LaneCardCategory.romance),
      LaneCard(id: id(), text: 'A night you will never forget', desireIndex: 99, category: LaneCardCategory.wild),
    ];
  }
}
