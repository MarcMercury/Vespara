...
class _ShareOrDareScreenState extends ConsumerState<ShareOrDareScreen>
  ...
  Widget _buildLobby(ShareOrDareState state) => Container(
                      ...
                      GestureDetector(
                        onTap: state.isLoading
                            ...
                            : () {
                                HapticFeedback.heavyImpact();
                                ref
                                    .read(shareOrDareProvider.notifier)
                                    .startGame();
                              },
                        child: Container(
                          width: double.infinity,
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color:
                                    VelvetColors.dareCrimson.withOpacity(0.4),
                                blurRadius: 20,
  ...
  Widget _buildHeatSelector(ShareOrDareState state) => Container(
  ...
  Widget _buildPlayerRow(ShareOrDarePlayer player, int index) => Container(
        ...
        child: Row(
          children: [
            ...
            IconButton(
              ...
              icon: const Icon(VesparaIcons.add, color: VelvetColors.shareBlue),
            ),
          ],
        ),
      );
  ...
  Widget _buildSpinning(ShareOrDareState state) => Container(
          ...
          builder: (context, constraints) {
            ...
            return Column(
              children: [
                ...
                // The Orbital Wheel
                GestureDetector(
                  onVerticalDragEnd: _spinVelocity == 0
                      ? (details) {
                      ...
                      : null,
                  onHorizontalDragEnd: _spinVelocity == 0
                      ? (details) {
                          final velocity = details.primaryVelocity ?? 0;
                          if (velocity.abs() > 100) {
                            _startSpin();
                      ...
                      children: [
                        ...
                        Transform.rotate(
                          ...
                          child: CustomPaint(
                            ...
                            painter:
                                OrbitalWheelPainter(players: state.players),
                          ),
                        ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border:
                                Border.all(color: VelvetColors.gold, width: 3),
                            boxShadow: [
                              BoxShadow(
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    fontWeight: FontWeight.w600,
                    color:
                        _spinVelocity > 0 ? VelvetColors.gold : Colors.white54,
                  ),
                ),
                  ...
                  builder: (context, child) => Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [
                          VelvetColors.dareCrimson,
                          Color(0xFFFF4500), // Orange-red fire
                        ],
                      ),
                      borderRadius: BorderRadius.circular(16),
                      boxShadow: [
                        BoxShadow(
                          color: VelvetColors.dareCrimson
                              .withOpacity(0.3 + _pulseController.value * 0.3),
                          blurRadius: 20 + _pulseController.value * 10,
                          spreadRadius: 2 + _pulseController.value * 3,
                        ),
  ...
  Widget _buildCardReveal(ShareOrDareState state) {
    ...
    if (state.phase == ShareOrDarePhase.revealing &&
        !_cardFlipController.isAnimating) {
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: showBack
                          ? Colors.white24
                          : card.typeColor.withOpacity(0.5),
                      width: 2,
                    ),
                    boxShadow: [
                      BoxShadow(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(12),
                    border: index == 0
                        ? Border.all(color: VelvetColors.gold)
                        : null,
                  ),
                  child: Row(
                    children: [
