...
class PlanEvent extends Equatable {
  ...
  factory PlanEvent.fromJson(Map<String, dynamic> json) => PlanEvent(
        id: json['id'] as String,
        ...
        connections: (json['connections'] as List?)
            ...
            [],
        certainty:
            EventCertaintyExtension.fromString(json['certainty'] as String?),
    ...
    DateTime? updatedAt,
      ...
      PlanEvent(
        ...
        externalCalendarSource:
            externalCalendarSource ?? this.externalCalendarSource,
