...
class _GroupDetailScreenState extends ConsumerState<GroupDetailScreen> {
  ...
  Future<void> _loadMembers() async {
    final members = await ref.read(groupsProvider.notifier)
  ...
  Widget _buildHeader(VesparaGroup group) {
    return Padding(
        ...
        children: [
          ...
          if (group.isCreator)
            IconButton(
              ...
              icon: const Icon(Icons.edit_outlined, color: VesparaColors.secondary),
            )
          else
  ...
  Widget _buildGroupInfo(VesparaGroup group) {
    return Container(
        ...
        children: [
          ...
          Container(
            ...
            child: group.avatarUrl != null
                ...
                : Icon(Icons.group, size: 40, color: VesparaColors.glow),
          ),
  ...
  Widget _buildQuickActions(VesparaGroup group) {
    return Padding(
  ...
  Widget _buildMembersSection(VesparaGroup group) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
        ...
        if (_isLoadingMembers)
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              return _buildMemberTile(_members[index], group);
            },
          ),
      ],
    );
  ...
  Widget _buildMemberTile(GroupMember member, VesparaGroup group) {
    return Container(
  ...
  Widget _buildInviteSection(VesparaGroup group) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
        ...
        Container(
          ...
          child: Row(
            children: [
              Icon(Icons.info_outline, color: VesparaColors.secondary, size: 18),
              const SizedBox(width: 12),
              Expanded(
                child: Text(
  ...
  Widget _buildDangerZone(VesparaGroup group) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            ListTile(
              leading: Icon(Icons.person, color: VesparaColors.primary),
              title: Text(
                'View Profile',
                style: TextStyle(color: VesparaColors.primary),
              ),
            ...
            ListTile(
              leading: Icon(Icons.remove_circle, color: VesparaColors.error),
              title: Text(
                'Remove from Group',
