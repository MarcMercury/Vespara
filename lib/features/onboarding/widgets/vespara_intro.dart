...
class _VesparaIntroState extends State<VesparaIntro>
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    ...
                    // Tap prompt
                    if (_showTapPrompt && !_hasBeenTapped) _buildTapPrompt(),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildAmbientGlow() => Positioned.fill(
        child: CustomPaint(
          ...
          decoration: const BoxDecoration(
            gradient: RadialGradient(
              ...
              colors: [
                ...
                Color(0xFF1A0A2E), // Darker purple
                Color(0xFF0A0510), // Almost black
              ],
              stops: [0.0, 0.5, 1.0],
            ),
          ),
                    ...
                    gradient: RadialGradient(
                      colors: [
                        const Color(0xFFD4AF37)
                            .withOpacity(0.3 * _leftCurtainAnim.value),
                        const Color(0xFFD4AF37)
                            .withOpacity(0.1 * _leftCurtainAnim.value),
                        Colors.transparent,
                      ],
                    ),
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xFFD4AF37)
                            .withOpacity(0.2 * _leftCurtainAnim.value),
                        blurRadius: 100,
                        spreadRadius: 50,
                      ),
                    ],
  ...
  Widget _buildCurtain({required bool isLeft}) {
    ...
    final xOffset =
        isLeft ? -screenWidth * 0.5 * progress : screenWidth * 0.5 * progress;
  ...
  Widget _buildSingleStanchion() => Container(
        width: 20,
        height: 120,
        decoration: BoxDecoration(
          gradient: const LinearGradient(
  ...
  Widget _buildTextOverlay() => Positioned.fill(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ...
            Opacity(
              opacity:
                  _titleFadeAnim.value * (1 - _leftCurtainAnim.value * 0.8),
              child: Transform.translate(
            ...
            Opacity(
              opacity:
                  _subtitleFadeAnim.value * (1 - _leftCurtainAnim.value * 0.8),
              child: Transform.translate(
  ...
  Widget _buildTapPrompt() => Positioned(
        left: 0,
        right: 0,
        bottom: 100,
        child: AnimatedOpacity(
              ...
              AnimatedBuilder(
                ...
                builder: (context, child) => Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color:
                          const Color(0xFFD4AF37).withOpacity(_glowAnim.value),
                      width: 2,
                    ),
                  ),
                  child: const Center(
...
class _AmbientGlowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (cornerRadius > 0) {
      ...
      canvas.drawCircle(const Offset(0, 0), cornerRadius, topGlowPaint);
