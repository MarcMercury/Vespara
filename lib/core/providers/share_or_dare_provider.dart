  ...
  List<ShareOrDareCard> _getPgCards(Random random) {
    return [
      ...
      ShareOrDareCard(
          ...
          type: CardType.share,
          text: 'Share the most embarrassing thing in your search history right now.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share your most irrational fear that you\'ve never told anyone.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share a compliment you desperately want but never receive.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share a guilty pleasure song that would absolutely ruin your reputation.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share what movie genre best describes your romantic history—and why.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share a red flag you ignored because the person was just that attractive.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share a celebrity encounter that would make you completely lose your cool.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share the most unhinged thing you\'ve ever done for a crush.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.icebreaker),
      // PG DARES
      ShareOrDareCard(
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Let someone go through your Spotify/music history and judge you.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Do your best impression of someone in this room until they guess who.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Post a story asking "who wants to hang out tonight" and don\'t explain.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Text your ex "hey" and show the response when it comes.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Let the group pick your profile photo for the next 24 hours.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Give a dramatic reading of your last text conversation out loud.',
          heatLevel: HeatLevel.pg,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Do a fashion show walk across the room like you\'re on a runway.',
          heatLevel: HeatLevel.pg,
  ...
  List<ShareOrDareCard> _getPg13Cards(Random random) {
    return [
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share your favorite way to be touched—describe it in 3 adjectives.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share a "vanilla" act that secretly turns you on more than it should.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share the most attractive thing someone has ever done for you.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share your type without describing anyone in this room.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share a fantasy you\'re embarrassed to admit you have.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share the most romantic gesture you\'ve ever made for someone.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share your honest rating of everyone in this room on a scale of 1-10.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share the longest you\'ve gone without kissing someone—and how that drought ended.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share which physical feature you get complimented on the most.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share your biggest turn-on that would surprise most people.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share a dream you\'ve had about someone in this room—spare no details.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share the most attractive thing about the person to your left.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.icebreaker),
      // PG-13 DARES
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Give the person to your left a neck massage for 60 seconds. No talking.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Whisper something flirty into someone\'s ear. They choose if they share it.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Let someone draw a heart anywhere on your body with their finger.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Make prolonged eye contact with someone for 30 seconds without laughing.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Let someone feed you something blindfolded. Trust them.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Give your best "bedroom eyes" to everyone in the room, one by one.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Describe in detail how you would seduce someone in this room.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Let someone brush or play with your hair for 2 minutes.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Send a voice note to someone confessing attraction. It can be a joke... or not.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.icebreaker),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Put on a blindfold and identify 3 people by touch alone.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Let the group pose you and one other person for a "romantic movie poster."',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Without kissing them, gently press your lips to another player and hold for 15 seconds.',
          heatLevel: HeatLevel.pg13,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
  ...
  List<ShareOrDareCard> _getRCards(Random random) {
    return [
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share the best sexual experience you\'ve ever had—in vivid detail.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share your most unconventional turn-on that you\'ve actually acted on.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share your ultimate fantasy scenario—paint the picture vividly.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share something you\'ve always wanted to try but haven\'t found the right partner for.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share the kinkiest thing you\'ve ever done—spare no details.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share who you\'d choose for a no-consequences night here—and why them.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share your safe word and the story behind why you chose it.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share a time you completely surprised yourself with how adventurous you were.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share a boundary you never thought you\'d cross—but did anyway.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share your honest self-rating in bed on a scale of 1-10—and justify it.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intimate thing you\'ve ever shared with a partner?',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most embarrassing sex-related story you\'ve shared with someone?',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most memorable sex-related dream you\'ve ever had?',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intimate thing you\'ve ever shared with a stranger?',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intense emotional connection you\'ve felt with someone?',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most memorable sex-related experience you\'ve ever had?',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intimate conversation with a partner about sex?',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.deep),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intense emotional connection with a partner?',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.deep),
      // R DARES
      ShareOrDareCard(
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Sit on the lap of the person the wheel spins to next (if consenting).',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Remove one item of clothing and explain why you chose that one.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Give someone a 2-minute massage wherever they request.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Demonstrate your best move on a pillow. Make it convincing.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Let someone whisper a command in your ear. You must do it.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Trade one piece of clothing with someone of your choosing.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Let someone leave a hickey on you in a visible location.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Recreate the most sensual scene from a movie with someone willing.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Describe what you would do if you had 10 minutes alone with someone here.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Crawl under the table (or just crawl) and choose a player to massage the crotch of.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.physical),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Without penetrating or grabbing - place your hands down the pants and under the underwear of another player.',
          heatLevel: HeatLevel.r,
          category: ShareOrDareCategory.physical),
    ];
  }
  ...
  List<ShareOrDareCard> _getXCards(Random random) {
    return [
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share your absolute darkest fantasy—the one you\'ve never told a soul.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share in explicit detail your ideal scenario with someone in this room.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share a taboo you\'ve broken that you absolutely don\'t regret.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share who in this room you\'d most want to... and describe exactly why.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'Share the most explicit message you\'ve ever sent—read it aloud now.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intense pain you\'ve experienced during sex?',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intense breathplay experience you\'ve ever had?',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intense sensory deprivation experience during sex?',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intense impact play experience you\'ve ever had?',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intense rope bondage experience you\'ve ever had?',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intense sex-related experience with a stranger?',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intense sex-related experience with a group?',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most intense BDSM scene you\'ve participated in?',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.share,
          text: 'What\'s the most unusual thing you\'ve done to get someone to agree to sex?',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // X DARES (with edits applied)
      // 1) Let 2 other players remove all your clothing
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Let 2 other players remove all your clothing.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 2) 3 minutes in another room naked with another player
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: '3 minutes in another room naked with another player.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 3) Kiss someone passionately for 30 seconds
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Kiss someone passionately for 30 seconds.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.physical),
      // 4) Let the group direct a sex scene between you and another player
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Let the group direct a sex scene between you and another player.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 5) Demonstrate your signature sex move/act on another player
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Demonstrate your signature sex move/act on another player.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 6) Strip Tease
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Strip Tease: Slowly do a strip tease for the group (must get down to underwear). Group chooses the song.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.physical),
      // 7) Lap Dance
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Lap Dance: Give a lap dance to 2 people at the same time. Group chooses the song.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.physical),
      // 8) Body Massage (edited)
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'In your underwear only, give another player a body massage using only your body (no hands).',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.physical),
      // 9) Blindfolded Kiss
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Blindfolded Kiss: Blindfold 2 other players and give them each a 1-minute kiss.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 10) Threeway Kiss
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Threeway Kiss: Give a 1-minute tongue kiss to 2 other players at the same time.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 11) Finger Play
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Finger Play: Give 2 other players a 1-minute finger play session.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 12) Threeway 69
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Threeway 69: Pick 2 people and figure out a 696 or 969 position together.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 13) Foot Play (edited)
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Give one player an X-rated foot play session.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 14) Oral Play (edited)
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Oral Play: Give one player oral play for 1-2 minutes.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 15) Nipple Play
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Nipple Play: Give 2 other players a 1-minute nipple play session.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 16) Anal Play
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Anal Play: Give 2 other players a 1-minute anal play session.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 17) Oral Threesome (edited)
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Oral Threesome: Pick 2 players and do an oral play train for 1-2 minutes.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      // 18) Sensual Lick
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Sensual Lick: Sensually lick anywhere on another player\'s body of your choosing.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Strip Tease: Choose 2 people to give you a strip tease, one item at a time.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.physical),
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Lap Dance: Choose 2 people to give you a lap dance at the same time. Group chooses the song.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.physical),
      // 21) Strip Massage (edited)
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Strip and let 2 players massage you however they want for 2 minutes.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.physical),
      // 22) Blindfold Make Out (edited)
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Blindfold yourself, and let the group secretly choose 2 people to make out with you for 2 minutes.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Threeway Kiss: Choose 2 people to give you a 1-minute tongue kiss at the same time.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Finger Play: Choose 2 people to give you a 1-minute finger play session.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Feet Play: Choose 2 people to give you a 1-minute feet play session.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Nipple Play: Choose 2 people to give you a 1-minute nipple play session.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Anal Play: Choose 2 people to give you a 1-minute anal play session.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Oral Play: Choose 2 people to give you a 1-minute oral play session.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
      ...
      ShareOrDareCard(
          id: '${random.nextInt(99999)}',
          type: CardType.dare,
          text: 'Sensual Lick: Choose 2 people to sensually lick anywhere on your body.',
          heatLevel: HeatLevel.x,
          category: ShareOrDareCategory.kinky),
