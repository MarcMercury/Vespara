...
class WireMessageBubble extends ConsumerWidget {
  ...
  Widget _buildSystemMessage(BuildContext context) => Center(
        child: Container(
  ...
  Widget _buildSmallAvatar() => Container(
        width: 28,
        height: 28,
  ...
  Widget _buildForwardedIndicator(BuildContext context) => const Padding(
  ...
  Widget _buildTextContent(BuildContext context, bool isMe) => Padding(
  ...
  Widget _buildImageContent(BuildContext context, bool isMe) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Image
  ...
  Widget _buildVideoContent(BuildContext context, bool isMe) => Stack(
  ...
  Widget _buildVoiceContent(BuildContext context, bool isMe) => Padding(
        padding: const EdgeInsets.all(12),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
                  ...
                  Row(
                    children: List.generate(
                      ...
                      (index) => Expanded(
                        child: Container(
                          height:
                              (message.mediaWaveform?.elementAtOrNull(index) ??
                                          0.5) *
                                      20 +
                                  4,
  ...
  Widget _buildFileContent(BuildContext context, bool isMe) => Padding(
        padding: const EdgeInsets.all(12),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
  ...
  Widget _buildLocationContent(BuildContext context, bool isMe) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Map placeholder
          Container(
  ...
  Widget _buildContactContent(BuildContext context, bool isMe) => Padding(
        padding: const EdgeInsets.all(12),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
  ...
  Widget _buildPollContent(BuildContext context, bool isMe) => Padding(
        padding: const EdgeInsets.all(12),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            if (message.pollOptions != null)
              ...message.pollOptions!.map(_buildPollOption),
            const SizedBox(height: 8),
            _buildTimeAndStatus(context, isMe),
          ],
        ),
  ...
  Widget _buildPollOption(PollOption option) {
    final totalVotes =
        message.pollOptions!.fold(0, (sum, o) => sum + o.voteCount);
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor:
                  const AlwaysStoppedAnimation<Color>(VesparaColors.glow),
              minHeight: 6,
            ),
          ),
        ],
  ...
  Widget _buildReactions(BuildContext context) => Container(
  ...
  Widget _buildTimeAndStatus(BuildContext context, bool isMe) => Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          // Edited indicator
          if (message.isEdited) ...[
