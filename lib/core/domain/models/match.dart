...
class Match extends Equatable {
  ...
  factory Match.fromJson(Map<String, dynamic> json, String currentUserId) {
    ...
    final priority = isUserA ? json['user_a_priority'] : json['user_b_priority'];
    final notes = isUserA ? json['user_a_notes'] : json['user_b_notes'];
    final isArchived = isUserA ? json['user_a_archived'] : json['user_b_archived'];
    ...
    return Match(
      ...
      matchedUserAvatar: (otherProfile?['photos'] as List?)?.firstOrNull as String?,
