...
/// Compatibility alias for legacy code using AppTheme
/// Provides static access to colors and text styles
class AppTheme {
  AppTheme._();
  
  // Colors
  static Color get backgroundDark => VesparaColors.background;
  static Color get surfaceDark => VesparaColors.surface;
  static Color get primary => VesparaColors.primary;
  static Color get secondary => VesparaColors.secondary;
  static Color get glow => VesparaColors.glow;
  
  // Text Styles - using Google Fonts directly for static access
