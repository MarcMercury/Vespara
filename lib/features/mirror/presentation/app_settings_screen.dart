...
class _AppSettingsScreenState extends ConsumerState<AppSettingsScreen>
  ...
  final String _experienceStyle = 'curated';
  final List<String> _selectedVibes = ['Intimate', 'Adventurous'];
  final List<String> _selectedDesires = [];
  final String _pacePreference = 'medium';
  ...
  Widget _buildPermissionsTab() => SingleChildScrollView(
        padding: const EdgeInsets.all(VesparaSpacing.lg),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            ListTile(
              leading: Container(
                ...
                child: Icon(
                  icon,
                  color:
                      isEnabled ? VesparaColors.glow : VesparaColors.secondary,
                ),
              ),
              title: Text(
                title,
  ...
  Widget _buildPrivacyNote() => Container(
        ...
        child: const Row(
          children: [
            ...
            SizedBox(width: VesparaSpacing.md),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
  ...
  Widget _buildNotificationsTab() => SingleChildScrollView(
        padding: const EdgeInsets.all(VesparaSpacing.lg),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            _buildNotificationSection(
              ...
              [
                _NotificationOption(
                  ...
                  subtitle:
                      'New experiences and updates to ones you\'re attending',
                  value: _experienceNotifications,
                  onChanged: (v) =>
                      setState(() => _experienceNotifications = v),
                ),
                _NotificationOption(
  ...
  Widget _buildQuietHoursCard() => Container(
        padding: const EdgeInsets.all(VesparaSpacing.md),
        decoration: BoxDecoration(
          color: VesparaColors.surface,
          borderRadius: BorderRadius.circular(VesparaBorderRadius.card),
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const Icon(Icons.bedtime_rounded, color: VesparaColors.glow),
                const SizedBox(width: VesparaSpacing.sm),
                const Text(
                  'Quiet Hours',
                  style: TextStyle(
  ...
  Widget _buildDiscoveryTab() => SingleChildScrollView(
        padding: const EdgeInsets.all(VesparaSpacing.lg),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              subtitle,
              style:
                  const TextStyle(color: VesparaColors.secondary, fontSize: 12),
            ),
            const SizedBox(height: VesparaSpacing.md),
            Row(
  ...
  Widget _buildIntegrationsTab() => SingleChildScrollView(
        padding: const EdgeInsets.all(VesparaSpacing.lg),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
              ...
              children: options.map((option) {
                ...
                return FilterChip(
                  ...
                  labelStyle: TextStyle(
                    color:
                        isSelected ? VesparaColors.glow : VesparaColors.primary,
                    fontSize: 12,
                  ),
                  backgroundColor: VesparaColors.background,
                  side: BorderSide(
                    color:
                        isSelected ? VesparaColors.glow : VesparaColors.border,
                  ),
                );
              }).toList(),
            ),
  ...
  Widget _buildAITab() => SingleChildScrollView(
        padding: const EdgeInsets.all(VesparaSpacing.lg),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
  ...
  Future<void> _requestPhotosPermission() async {
    HapticFeedback.mediumImpact();
    final file =
        await _permissionService.pickImageFromGallery(context: context);
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            style:
                ElevatedButton.styleFrom(backgroundColor: VesparaColors.glow),
