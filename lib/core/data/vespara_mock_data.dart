...
class MockDataProvider {
  ...
  static List<TagsGame> get tagsGames => [
    TagsGame(
      id: 'game-1',
      title: 'Down to Clown',
      description: 'Heads Up-style guessing game with spicy vocabulary. Hold up the phone, guess the word!',
    ...
    TagsGame(
      id: 'game-2',
      title: 'Ice Breakers',
      description: 'Conversation starters for breaking the tension. Fun, flirty, and not too personal.',
    ...
    TagsGame(
      id: 'game-7',
      title: 'Flash & Freeze',
      description: 'Red Light, Green Light evolved. Exposure requires endurance.',
