...
class EventTileCard extends StatelessWidget {
  ...
  UserEventStatus get _userStatus {
    ...
    final rsvp = event.rsvps.where((r) => r.userId == currentUserId).firstOrNull;
  ...
  IconData _getEventIcon() {
    ...
    if (title.contains('dinner') || title.contains('eat') || title.contains('food')) {
              ...
              child: ClipOval(
                child: avatars[index] != null
                    ? Image.network(
                        avatars[index]!,
                        fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) => _buildAvatarPlaceholder(index),
                      )
