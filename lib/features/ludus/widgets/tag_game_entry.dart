...
class TagGameEntry extends StatefulWidget {
  ...
  final Widget? customContent; // For games that need extra setup (player count, heat select)
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Icon(VesparaIcons.games, size: 14, color: widget.primaryColor),
      ...
      builder: (context, child) {
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: widget.primaryColor.withOpacity(0.2 + _glowController.value * 0.3),
        ...
        builder: (context, child) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: widget.primaryColor.withOpacity(0.3 + _glowController.value * 0.2),
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Icon(VesparaIcons.play, color: Colors.white, size: 22),
