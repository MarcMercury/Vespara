...
class _AchievementUnlockOverlayState extends State<AchievementUnlockOverlay>
  ...
  Widget _buildBadge(String text, IconData? icon, Color color) => Container(
          ...
          children: [
            ...
            Container(
              ...
              child: Icon(
                ...
                size: 28,
                color: isUnlocked ? achievement.rarityColor : Colors.white38,
              ),
            ),
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    color:
                        isUnlocked ? achievement.rarityColor : Colors.white38,
                    fontSize: 10,
