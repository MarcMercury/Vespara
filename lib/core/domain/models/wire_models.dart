...
class WireConversation extends Equatable {
  ...
  factory WireConversation.fromJson(Map<String, dynamic> json) {
    ...
    return WireConversation(
      ...
      matchAvatarUrl: matchData?['avatar_url'] as String? ??
          json['match_avatar_url'] as String?,
      ...
      onlyAdminsCanEditInfo:
          json['only_admins_can_edit_info'] as bool? ?? false,
      allowMemberInvite: json['allow_member_invite'] as bool? ?? true,
      disappearingMessagesSeconds:
          json['disappearing_messages_seconds'] as int?,
  ...
  String? get avatarUrl =>
      type == ConversationType.group ? groupAvatarUrl : matchAvatarUrl;
