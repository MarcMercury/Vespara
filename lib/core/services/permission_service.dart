...
class PermissionResult {
  ...
  bool get isGranted => status == VesparaPermissionStatus.granted || 
                         status == VesparaPermissionStatus.limited;
  
  bool get isPermanentlyDenied => status == VesparaPermissionStatus.permanentlyDenied;
}
...
class PermissionService {
  ...
  VesparaPermissionStatus _mapLocationPermission(LocationPermission permission) {
    switch (permission) {
  ...
  Future<Map<VesparaPermission, VesparaPermissionStatus>> checkAllPermissions() async {
