...
class _BadIdeaScreenState extends State<BadIdeaScreen>
  ...
  static const List<String> _chaosAddons = [
    ...
    'Also tag your ex, their cousin, and one random senator.',
  ...
  Future<void> _generateBadIdea() async {
    ...
    if (isRare) {
      ...
      final allIdeas = _ideasByVibe.expand((group) => group).toList();
      final picked = allIdeas[rng.nextInt(allIdeas.length)];
      idea = _BadIdea(
