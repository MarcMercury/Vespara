      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Text(_analysis!.toneEmoji, style: const TextStyle(fontSize: 16)),
                const SizedBox(width: 8),
                Text(
                  _analysis!.toneLabel,
                  style: TextStyle(
            ...
            if (_analysis!.tips.isNotEmpty) ...[
              const SizedBox(height: 8),
              ..._analysis!.tips.map((tip) => _CoachingTipRow(
                    tip: tip,
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Text(progress.stage.emoji, style: const TextStyle(fontSize: 32)),
                const SizedBox(width: 16),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
            ...
            if (progress.milestones.isNotEmpty) ...[
              ...
              ...progress.milestones.reversed.take(5).map((m) => _MilestoneRow(
                    milestone: m,
                  )),
            ],
