...
class _BadIdeaScreenState extends State<BadIdeaScreen>
  ...
  static const List<_BadIdea> _communityIdeas = [
    _BadIdea(idea: 'Recruit three strangers for an experiment you barely understand, then appoint yourself facilitator.', regret: 10),
    _BadIdea(idea: 'Turn one flirty conversation into a six-person side quest before anyone finishes their drink.', regret: 10),
    _BadIdea(idea: 'Walk into the busiest room and announce "okay, who wants to try something wildly educational?"', regret: 9),
    _BadIdea(idea: 'Bring a whiteboard to aftercare and map everyone\'s logistics like it\'s a startup pitch.', regret: 9),
    _BadIdea(idea: 'Ask nearby people to vote on your next questionable decision and honor the results immediately.', regret: 8),
    _BadIdea(idea: 'Turn a consent check into a full tactical briefing with hand gestures and role assignments.', regret: 9),
    _BadIdea(idea: 'Announce phase two before phase one is complete and recruit backup anyway.', regret: 10),
    _BadIdea(idea: 'Join a room mid-scene, whisper "I can optimize this," and begin reorganizing humans.', regret: 10),
    _BadIdea(idea: 'Promise to keep it chill, then launch a spontaneous group activity with a countdown timer.', regret: 8),
    _BadIdea(idea: 'Treat the evening like a social lab and narrate your findings to anyone holding water.', regret: 8),
    _BadIdea(idea: 'Start a mini tournament no one requested and assign brackets based on eye contact intensity.', regret: 9),
    _BadIdea(idea: 'Pitch a collaborative stunt by saying "it\'s mostly communication and vibes."', regret: 9),
    _BadIdea(idea: 'Start a spontaneous orientation tour of the dungeon despite having no official role.', regret: 9),
    _BadIdea(idea: 'Suggest a "friendly chaos speedrun" and hand strangers random responsibilities.', regret: 10),
    _BadIdea(idea: 'Declare that everyone deserves a dramatic origin story tonight and begin producing one.', regret: 9),
    _BadIdea(idea: 'Launch an unplanned "chemistry audit" and ask pairs to report findings.', regret: 10),
    _BadIdea(idea: 'Offer to be the neutral referee, then clearly pick favorites based on vibes.', regret: 8),
    _BadIdea(idea: 'Start a consent-themed drinking game that somehow requires a clipboard.', regret: 10),
    _BadIdea(idea: 'Turn a hallway conversation into a large-scale side quest with rotating captains.', regret: 9),
    _BadIdea(idea: 'Grab a marker and write "phase one" on your arm like this is a military operation.', regret: 8),
  ];
  ...
  static const List<List<_BadIdea>> _ideasByVibe = [
    ...
    [
      ...
      _BadIdea(idea: 'Volunteer to demonstrate something you only saw once on YouTube.', regret: 9),
      ...
      _BadIdea(idea: 'Decide the best way to meet people is to challenge them to a dare.', regret: 9),
      _BadIdea(idea: 'Start a rumor that there\'s a secret room upstairs and recruit explorers.', regret: 9),
      _BadIdea(idea: 'Pick two people at random and tell them "you two have incredible chemistry."', regret: 8),
      _BadIdea(idea: 'Announce that you\'re starting a "bad decision support group."', regret: 8),
      _BadIdea(idea: 'Begin narrating what\'s happening in the room like a sports commentator.', regret: 8),
      _BadIdea(idea: 'Recruit three volunteers for something you haven\'t fully explained yet.', regret: 10),
      ...
      _BadIdea(idea: 'Wander into a room, clap once loudly, and say "okay hear me out."', regret: 8),
      _BadIdea(idea: 'Start collecting bets on how chaotic the night will become.', regret: 8),
      _BadIdea(idea: 'Treat the toy table like a buffet and announce your "top five picks."', regret: 9),
      _BadIdea(idea: 'Tell someone "this will either be genius or a disaster" and proceed anyway.', regret: 9),
      ...
      _BadIdea(idea: 'Ask if anyone wants to try something that probably violates physics.', regret: 10),
      _BadIdea(idea: 'Declare that the vibe is getting too calm and attempt to fix it.', regret: 8),
      _BadIdea(idea: 'Recruit someone to help you test a terrible theory.', regret: 9),
      _BadIdea(idea: 'Walk into a room and loudly say "okay who\'s responsible for this chaos?"', regret: 7),
      ...
      _BadIdea(idea: 'Decide the best way to break the ice is to start a confession circle.', regret: 9),
      _BadIdea(idea: 'Offer to "coordinate" something nobody asked you to coordinate.', regret: 9),
      _BadIdea(idea: 'Start explaining a plan that somehow involves everyone in the room.', regret: 10),
      _BadIdea(idea: 'Ask someone "on a scale of one to terrible decisions, how adventurous are you?"', regret: 8),
      _BadIdea(idea: 'Begin describing a story that ends with "and that\'s why this seems like a good idea."', regret: 8),
      _BadIdea(idea: 'Start polling strangers about the most chaotic thing they\'ve ever done.', regret: 7),
      _BadIdea(idea: 'Treat the evening like a live social experiment.', regret: 9),
      _BadIdea(idea: 'Offer to referee something nobody realized was competitive.', regret: 8),
      _BadIdea(idea: 'Suggest escalating the situation "purely for science."', regret: 9),
      _BadIdea(idea: 'Announce you\'re about to try something extremely questionable.', regret: 9),
      _BadIdea(idea: 'Invite someone to join you in "making this night historically confusing."', regret: 10),
      _BadIdea(idea: 'Start recruiting participants for something you\'re calling "Phase Two."', regret: 10),
      _BadIdea(idea: 'Tell someone "I promise this will be funny later."', regret: 8),
      ...
      _BadIdea(idea: 'Decide the vibe needs "one more terrible decision."', regret: 9),
      _BadIdea(idea: 'Ask the room "who here makes bad choices professionally?"', regret: 8),
      _BadIdea(idea: 'Declare yourself the unofficial chaos coordinator.', regret: 8),
      _BadIdea(idea: 'Start telling people "trust me, this always works."', regret: 9),
      _BadIdea(idea: 'Suggest combining two completely unrelated ideas.', regret: 9),
      _BadIdea(idea: 'Invite someone to help you "see how far this can go."', regret: 9),
      _BadIdea(idea: 'Decide the best possible outcome is a story nobody believes tomorrow.', regret: 9),
      _BadIdea(idea: 'Look around the room, grin, and say "I have an idea."', regret: 8),
      ...
      _BadIdea(idea: 'Announce you\'re taking it slow tonight, then immediately follow the loudest room in the house.', regret: 8),
      ...
      _BadIdea(idea: 'Introduce two partners to each other and casually suggest everyone hang out later.', regret: 10),
      _BadIdea(idea: 'Start describing a "really interesting idea you just had" and recruit volunteers before finishing the explanation.', regret: 9),
      _BadIdea(idea: 'Wander into a crowded room, sit down in the middle, and see what happens.', regret: 8),
      _BadIdea(idea: 'Decide hydration counts as preparation and proceed accordingly.', regret: 7),
      _BadIdea(idea: 'Attempt something you vaguely remember from a workshop you attended once.', regret: 9),
      _BadIdea(idea: 'Turn a quiet moment into a group activity by inviting whoever happens to be nearby.', regret: 8),
      _BadIdea(idea: 'Gather a few people together and announce you think the vibe could be "slightly more adventurous."', regret: 9),
      _BadIdea(idea: 'Turn curiosity into a plan and invite the nearest participants.', regret: 8),
      _BadIdea(idea: 'Start an ambitious new plan halfway through another plan.', regret: 9),
      _BadIdea(idea: 'Decide the best way to learn something is to try it immediately with an audience.', regret: 9),
      _BadIdea(idea: 'Turn a casual flirtation into a multi-person situation before anyone finishes their drink.', regret: 10),
      _BadIdea(idea: 'Recruit someone nearby to help you test a theory about how the night could escalate.', regret: 8),
      _BadIdea(idea: 'Turn a quiet conversation into a spontaneous group hangout.', regret: 7),
      _BadIdea(idea: 'Wander into a room, assess the situation, and decide to participate without asking too many questions.', regret: 9),
      _BadIdea(idea: 'Invite someone to join you in exploring whatever is happening in the next room.', regret: 8),
      _BadIdea(idea: 'Decide the night could benefit from more chaos and act accordingly.', regret: 9),
      _BadIdea(idea: 'Take a suggestion someone makes jokingly and treat it like a real plan.', regret: 8),
      _BadIdea(idea: 'Ask if anyone is curious about trying something new and immediately begin organizing it.', regret: 8),
      _BadIdea(idea: 'Turn a simple idea into a full-scale operation involving several people.', regret: 10),
      _BadIdea(idea: 'Walk into the next room and commit to whatever the vibe happens to be.', regret: 8),
      _BadIdea(idea: 'Suggest adding one more participant to an already complicated situation.', regret: 10),
      _BadIdea(idea: 'Assume enthusiasm is enough preparation and proceed confidently.', regret: 8),
      _BadIdea(idea: 'Attempt something ambitious purely because everyone seems curious.', regret: 9),
      _BadIdea(idea: 'Turn a brief moment of eye contact into a shared adventure.', regret: 8),
      _BadIdea(idea: 'Follow someone into another room just to see what happens.', regret: 7),
      _BadIdea(idea: 'Suggest escalating the situation slightly and see who agrees.', regret: 8),
      _BadIdea(idea: 'Recruit a small group to test an idea you just came up with.', regret: 9),
      _BadIdea(idea: 'Turn a casual hangout into an unsupervised social experiment.', regret: 9),
      _BadIdea(idea: 'Start something new simply because nobody else has yet.', regret: 8),
      _BadIdea(idea: 'Invite someone to help you "figure out how this works."', regret: 8),
      _BadIdea(idea: 'Turn a relaxed moment into a spontaneous adventure.', regret: 8),
      _BadIdea(idea: 'Take a passing comment and build an entire plan around it.', regret: 9),
      ...
      _BadIdea(idea: 'Turn a quiet evening into a logistical puzzle involving several people.', regret: 9),
      _BadIdea(idea: 'Suggest a slightly wilder version of what\'s already happening.', regret: 8),
      _BadIdea(idea: 'Decide the night could use a memorable story and start creating one.', regret: 8),
      _BadIdea(idea: 'Gather people together and see what they\'re willing to try.', regret: 8),
      _BadIdea(idea: 'Follow the most interesting energy in the room and get involved.', regret: 7),
      _BadIdea(idea: 'Turn a vague idea into a real activity with volunteers.', regret: 8),
      _BadIdea(idea: 'Treat the night like a choose-your-own-adventure and keep turning the page.', regret: 7),
      _BadIdea(idea: 'Commit to an idea purely because everyone laughed at it.', regret: 8),
      _BadIdea(idea: 'Turn a casual suggestion into an elaborate scenario.', regret: 9),
      _BadIdea(idea: 'Start something new because the vibe feels right.', regret: 7),
      _BadIdea(idea: 'Decide this is definitely going to be a great story tomorrow and proceed.', regret: 8),
    ],
  ];
  ...
  static const List<_BadIdea> _rareIdeas = [
    _BadIdea(
      idea: 'Rent a rooftop projector to display "CHAOS BUT WITH CONSENT" while inviting volunteers to a midnight demo.',
      regret: 11,
    ),
    _BadIdea(
