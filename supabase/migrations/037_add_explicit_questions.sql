...
-- Note: Database uses 'truth' type for Share questions
-- ═══════════════════════════════════════════════════════════════════════════

-- R-Rated Shares (Explicit)
INSERT INTO velvet_rope_cards (type, text, heat_level, category) VALUES
('truth', 'What''s the most adventurous sex act you''ve ever tried?', 'R', 'kinky'),
('truth', 'What''s the most intimate thing you''ve ever shared with a partner?', 'R', 'deep'),
('truth', 'What''s the biggest sex-related lie you''ve ever told?', 'R', 'deep'),
('truth', 'What''s the most spontaneous sex you''ve ever had?', 'R', 'kinky'),
('truth', 'What''s the most embarrassing sex-related story you''ve ever shared?', 'R', 'deep'),
('truth', 'What''s the biggest turn-on for you?', 'R', 'kinky'),
('truth', 'What''s the most intense orgasm you''ve ever had?', 'R', 'kinky'),
('truth', 'What''s the most unusual place you''ve ever had sex?', 'R', 'kinky'),
('truth', 'What''s the biggest sex-related fantasy you''ve ever had?', 'R', 'kinky'),
('truth', 'What''s the most memorable sex-related dream you''ve ever had?', 'R', 'kinky'),
('truth', 'What''s your favorite sex position?', 'R', 'kinky'),
('truth', 'What''s your favorite BDSM role (dom, sub, switch)?', 'R', 'kinky'),
('truth', 'What''s the most creative way you''ve ever seduced someone?', 'R', 'deep'),
('truth', 'What''s the most intimate thing you''ve ever shared with a stranger?', 'R', 'deep'),
('truth', 'What''s the most intense emotional connection you''ve felt with someone?', 'R', 'deep'),
('truth', 'What''s the most intense moment of vulnerability with someone?', 'R', 'deep'),
('truth', 'What''s the most intense moment of trust with someone?', 'R', 'deep'),
('truth', 'What''s the most memorable sex-related experience you''ve ever had?', 'R', 'kinky'),
('truth', 'What''s your favorite sex-related fantasy?', 'R', 'kinky'),
('truth', 'What''s the most intimate conversation with a partner about sex?', 'R', 'deep'),
('truth', 'What''s the most intense emotional connection with a partner about sex?', 'R', 'deep'),

-- X-Rated Shares (Extreme)
('truth', 'What''s the most extreme BDSM experience you''ve ever had?', 'X', 'kinky'),
('truth', 'What''s the most intense pain you''ve experienced during sex?', 'X', 'kinky'),
('truth', 'What''s the most creative way you''ve ever used bondage?', 'X', 'kinky'),
('truth', 'What''s the most intense sensory experience during sex?', 'X', 'kinky'),
('truth', 'What''s the most extreme fetish you''ve ever explored?', 'X', 'kinky'),
('truth', 'What''s the most intense breathplay experience you''ve ever had?', 'X', 'kinky'),
('truth', 'What''s the most intense sensory deprivation experience during sex?', 'X', 'kinky'),
('truth', 'What''s the most intense impact play experience you''ve ever had?', 'X', 'kinky'),
('truth', 'What''s the most intense rope bondage experience you''ve ever had?', 'X', 'kinky'),
('truth', 'What''s the most intense sex-related experience with a stranger?', 'X', 'kinky'),
('truth', 'What''s the most intense sex-related experience with a group?', 'X', 'kinky'),
('truth', 'What''s the most intense sex-related experience in a public place?', 'X', 'kinky'),
('truth', 'What''s the most intense sex-related experience with a stranger in a public place?', 'X', 'kinky'),
('truth', 'What''s your favorite BDSM toy or prop?', 'X', 'kinky'),
('truth', 'What''s the most intense BDSM scene you''ve ever participated in?', 'X', 'kinky'),
('truth', 'What''s the most intense BDSM experience with a partner?', 'X', 'kinky'),
('truth', 'What''s the most intense BDSM experience with a group?', 'X', 'kinky'),
('truth', 'What''s the most intense BDSM experience with a stranger?', 'X', 'kinky');
